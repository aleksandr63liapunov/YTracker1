    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (ddl.equals("create") || ddl.equals("create-drop")) {
            ...
            Transaction transaction1 = new Transaction(0L, expenseWallet2, incomeWallet2,
                    TypeOfTransation.EXPENSE, 985.0, "blocNote2",new GregorianCalendar(), incomeWallet2,tag1);

            Transaction transaction2 = new Transaction(0L, expenseWallet1, incomeWallet1,
                    TypeOfTransation.TRANSFER, 985.0, "blocNote2",new GregorianCalendar(2020, 5 , 10), expenseWallet1,tag2);
